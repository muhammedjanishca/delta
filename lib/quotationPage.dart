...
//  final List<CartItem> cartItems; // Update the type if needed
...
//                       DataCell(_buildTableCell(cartItems[i].productName)),
//                                         DataCell(_buildTableCell(cartItems[i].productCode)),

//                       DataCell(_buildTableCell('${cartItems[i].quantity}')),
//                       DataCell(_buildTableCell('unit')),
//                       DataCell(
//                         _buildTableCell('\$${cartItems[i].price}',
