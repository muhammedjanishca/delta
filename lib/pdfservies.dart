...
//     class PdfService{
//   Future<void> generateInvoice(List<CartItem> cartItems) async {
...
//   PdfGrid getGrid(List<CartItem> cartItems) {
//     //Create a PDF grid
...
//     row.cells[4].value = "Unit"; // Unit (you can replace with the actual unit)
