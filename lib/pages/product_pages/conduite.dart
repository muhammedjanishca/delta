...
class ConduitesPage extends StatelessWidget {
  ConduitesPage({super.key});
 ...
 double thumbnailSize = screenSize.width * 0.11; 
    ...
    return Consumer(builder: (context, provider, child) {
      return FutureBuilder<ProduceNewModal>(
        future: context.read<DataProvider>().newconduits,
  ...
  selectedPriceNotifieru.resetSelectedPrice();
                          ...
                          navigateToProductDetailsOfConduits(context,index,productname: snapshot.data!.data[index].productName!.replaceAll(" ", "_"));
                        },
                        child: Container(
                          //  height: 200,
                          width: _width / 4,
