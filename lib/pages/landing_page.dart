                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(headingss[index],style:GoogleFonts.abrilFatface(textStyle:TextStyle(color:const Color.fromARGB(255, 54, 98, 98),fontSize: 20,fontWeight: FontWeight.w700),) ),
                      Text(descriptionn[index],style: TextStyle(fontSize: 17,fontWeight: FontWeight.w400),)
                    ],
                  ),
